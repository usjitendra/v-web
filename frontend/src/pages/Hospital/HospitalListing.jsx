                        ...
                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <div className="p-4 sm:p-6 md:p-8">
                                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                                    ...
                                    <div className="flex-1 text-center sm:text-left">
                                        ...
                                        <span className="inline-block bg-blue-100 text-main-700 px-3 py-1 rounded-full text-sm font-medium mb-3">
                                            Cardiac Hospital
                                        </span>
                            ...
                            <div className="border-t border-gray-200 p-4 sm:p-6 md:p-8">
                                ...
                                <button
                                    ...
                                    className="mt-4 text-green-600 hover:text-blue-700 font-semibold"
                                >
                            ...
                            <div className="p-4 sm:p-6 md:p-8">
                                <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                                    ...
                                    <div className="flex-1 text-center sm:text-left">
                                        ...
                                        <span className="inline-block bg-blue-100 text-green-700 px-3 py-1 rounded-full text-sm font-medium mb-3">
                                            Cardiac Surgeon
                                        </span>
